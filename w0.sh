...
EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/multi_plus_ips.py
...
EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/multi_plus_naive.py
for index in ${!experiments[*]}; do
    wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
    $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
done
...
EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/ips_plus.py
for index in ${!experiments[*]}; do
    wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
    $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
done
...
EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/akb_ips_plus.py
for index in ${!experiments[*]}; do
    wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
    $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
done
...
EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/naive_plus.py
for index in ${!experiments[*]}; do
    wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
    $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
done
...
# )
# EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/escm2_plus_ips.py
# for index in ${!experiments[*]}; do
#     wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
#     $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
# done
...
# )
# EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/escm2_plus_naive.py
# for index in ${!experiments[*]}; do
#     wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
#     $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
# done
...
# )
# EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/esmm_plus.py
# for index in ${!experiments[*]}; do
#     wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
#     $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
# done
...
# )
# EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/v2_plus_ips.py
# for index in ${!experiments[*]}; do
#     wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
#     $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
# done
...
# )
# EXECUTION_FILE=$REPO_DIR/Github/no_ips/causality/v2_plus_naive.py
# for index in ${!experiments[*]}; do
#     wandb login a1f59c7a0e53eed9b11d25edae53fdbe676fb53a
#     $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$DATA_DIR --random-seed=$RANDOM_SEED
# done
