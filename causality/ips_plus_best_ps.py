...
from module.model import NCFPlus, SharedNCFPlus
...
wandb.run.name = f"single_ips_plus_bestps_causality_{expt_num}"
...
torch.save(model.state_dict(), f"./weights/ips_plus_{dataset_name[:3]}_{ps_model_name}_{random_seed}.pth")