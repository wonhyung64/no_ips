...
for epoch in range(1, num_epochs+1):
    ...
    for idx in range(total_batch):
        ...
        y1_loss = torch.mean(rec_loss * sub_t) * omega0
...
torch.save(model.state_dict(), f"./{base_model}_causality_weights/v2_plus_naive_{dataset_name[:3]}_omega{omega}_seed{random_seed}.pth")
