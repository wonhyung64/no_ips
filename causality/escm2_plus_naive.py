...
wandb.run.name = f"escm2_plus_naive_causality_{expt_num}"
...
torch.save(model.state_dict(), f"./{base_model}_causality_weights/escm2_plus_naive_{dataset_name[:3]}_omega{omega}_seed{random_seed}.pth")
# %%
