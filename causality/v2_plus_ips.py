...
wandb.run.name = f"v2_plus_ips_causality_{expt_num}"
...
torch.save(model.state_dict(), f"./{base_model}_causality_weights/v2_plus_ips_{dataset_name[:3]}_omega{omega}_seed{random_seed}.pth")
