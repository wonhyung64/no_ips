...
wandb.run.name = f"sen_escm2_plus_naive_causality_{expt_num}"
...
torch.save(model.state_dict(), f"./sen{str(gamma)}_escm2_naive_plus_{dataset_name[:3]}_seed{random_seed}.pth")
# %%
