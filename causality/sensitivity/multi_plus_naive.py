...
wandb.run.name = f"sen_multi_plus_naive_causality_{expt_num}"
...
torch.save(model.state_dict(), f"./sen{str(gamma)}_multi_naive_plus_{dataset_name[:3]}_seed{random_seed}.pth")
# %%
