...
wandb.run.name = f"sen_multi_plus_ips_causality_{expt_num}"
...
torch.save(model.state_dict(), f"./sen{str(gamma)}_multi_ips_plus_{dataset_name[:3]}_seed{random_seed}.pth")
